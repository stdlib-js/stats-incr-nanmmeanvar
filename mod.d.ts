...
/**
* If provided a value, the accumulator function returns an updated moving arithmetic mean and unbiased sample variance. If provided `NaN` or no value, the accumulator function returns the current moving arithmetic mean and unbiased sample variance.
*
* @param x - input value
...
/**
* Returns an accumulator function which incrementally computes a moving arithmetic mean and unbiased sample variance, ignoring `NaN` values.
*
* ## Notes
*
